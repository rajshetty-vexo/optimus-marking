...
//           {/* ── 🆕 INDEX 5: Nayi Labelling Solution Showcase video slide ── */}
//           {current === 5 && (
//             <div
//               ref={slideContentRef}
//               className="relative w-full h-auto min-h-[calc(100vh-4.6rem)] flex flex-col lg:grid lg:grid-cols-2 items-center justify-center bg-white pt-16 sm:pt-20 lg:pt-24 pb-16 px-5 sm:px-10 md:px-14 lg:px-20 gap-6 sm:gap-8 overflow-hidden"
...
/* ⚡ OPTIMIZED GLOBAL ROOT */
        ...
        /* 📱 Mobile Specific Overrides to ensure dots are completely safe */
        @media (max-width: 1024px) {
          .hs-root {
            min-height: calc(100vh - 4rem);
            min-height: calc(100dvh - 4rem);
          ...
          /* Dots strictly absolute background visibility layout */
          .hs-dots {
