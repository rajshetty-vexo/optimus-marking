      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 md:h-20">
          <a href="#home" className="flex-shrink-0">
            <img src={optimusLogo} alt="Optimus Marking" draggable={false} className="h-14 md:h-16 w-auto select-none" />
          </a>
            ...
            <div className="px-4 py-4 space-y-3">
              {navLinks.map((link) => (
                <a
                  ...
                  className="block text-foreground/70 hover:text-orange transition-colors font-display tracking-wider uppercase text-sm py-2"
                >
                  {link.label}
                </a>
              ))}
