      ...
      >
        {products.map((cat, index) => {
          ...
          return (
            ...
            >
              {/* Layer 1: Outer Polygonal Border Wrapper Component */}
              <div
              ...
              <div
                ...
                style={{ clipPath: "polygon(50% 0%, 100% 25%, 100% 75%, 50% 100%, 0% 75%, 0% 25%)" }}
              >
                {/* Product/Category Header Title Block */}
                ...
                {/* Product Range Center Graphic Viewport */}
          ...
          {products.map((_, i) => {
            ...
            return (
              <div key={i} className="relative flex items-center justify-center">
                ...
                {isSelected && (
                  <motion.div 
                    layoutId={`activeMobileDot-${title.replace(/\s+/g, "-").toLowerCase()}`}
